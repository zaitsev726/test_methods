...
public class DeleteCustomerWithLoginTest {
    ...
    @Test(description = "Delete customer with login via UI.",
            dependsOnMethods = {"createCustomer"})
    @Severity(SeverityLevel.BLOCKER)
    @Feature("Customer feature.")
    public void deleteCustomerTest() {
        result.searchCustomer(customer.login);
        result.deleteFirstCustomer();
    }
